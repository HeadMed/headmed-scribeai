...
async def create_new_patient(
    ...
    return await create_patient(session, patient_data, current_user)
...
async def get_patient(
    ...
    return await get_patient_by_id(session, patient_id, current_user)
...
async def get_patient_by_document(
    ...
    return await get_patient_by_cpf(session, cpf, current_user)
...
async def update_existing_patient(
    ...
    return await update_patient(session, patient_id, patient_data, current_user)
